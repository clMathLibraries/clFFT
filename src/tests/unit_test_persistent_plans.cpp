...
void test_persistent_plan(size_t *length, clfftLayout input_layout,
                          clfftLayout output_layout,
                          clfftResultLocation result_location) {
  try {
...
TEST_F(clfft_PersistentPlans, DISABLED_normal_1d_inplace_interleaved) {
  ...
  test_persistent_plan(length, CLFFT_COMPLEX_INTERLEAVED,
                       CLFFT_COMPLEX_INTERLEAVED, CLFFT_INPLACE);
}
...
TEST_F(clfft_PersistentPlans,
       DISABLED_normal_normal_normal_3d_inplace_interleaved) {
...
TEST_F(clfft_PersistentPlans, DISABLED_normal_1d_inplace_planar) {
  size_t length[3] = {1024, 1, 1};
  test_persistent_plan(length, CLFFT_COMPLEX_PLANAR, CLFFT_COMPLEX_PLANAR,
                       CLFFT_INPLACE);
}
...
TEST_F(clfft_PersistentPlans, DISABLED_normal_1d_outofplace_interleaved) {
  size_t length[3] = {1024, 1, 1};
  test_persistent_plan(length, CLFFT_COMPLEX_INTERLEAVED,
                       CLFFT_COMPLEX_INTERLEAVED, CLFFT_OUTOFPLACE);
}
...
TEST_F(clfft_PersistentPlans,
       DISABLED_normal_normal_2d_outofplace_interleaved) {
  size_t length[3] = {1024, 1024, 1};
  test_persistent_plan(length, CLFFT_COMPLEX_INTERLEAVED,
                       CLFFT_COMPLEX_INTERLEAVED, CLFFT_OUTOFPLACE);
}
...
TEST_F(clfft_PersistentPlans,
       DISABLED_normal_normal_normal_3d_outofplace_interleaved) {
  size_t length[3] = {32, 32, 32};
  test_persistent_plan(length, CLFFT_COMPLEX_INTERLEAVED,
                       CLFFT_COMPLEX_INTERLEAVED, CLFFT_OUTOFPLACE);
}
...
TEST_F(clfft_PersistentPlans,
       DISABLED_mixed_radices_3d_outofplace_interleaved) {
  size_t length[3] = {2 * 3 * 5, 2 * 3 * 5, 2 * 3 * 5};
  test_persistent_plan(length, CLFFT_COMPLEX_INTERLEAVED,
                       CLFFT_COMPLEX_INTERLEAVED, CLFFT_OUTOFPLACE);
}
...
TEST_F(clfft_PersistentPlans,
       DISABLED_normal_normal_normal_3d_outofplace_planar) {
  size_t length[3] = {32, 32, 32};
  test_persistent_plan(length, CLFFT_COMPLEX_PLANAR, CLFFT_COMPLEX_PLANAR,
                       CLFFT_OUTOFPLACE);
}
