...
TEST_F(accuracy_test_pow5_precallback_single,
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_1D_forward_in_place_complex_planar_to_complex_planar) {
  try {
    normal_1D_forward_in_place_complex_planar_to_complex_planar<
...
// 78125 = 125 * 125 * 5, backward, planar and interleaved, single and double,
// batch size 1 and 3
TEST_F(
    accuracy_test_pow5_precallback_single,
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    normal_1D_array_precallback_complex_to_complex<float, cl_float,
                                                   fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_1D_array_precallback_complex_to_complex) {
  try {
    normal_1D_array_precallback_complex_to_complex<double, cl_double,
                                                   fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       large_1D_array_precallback_complex_to_complex) {
  try {
    large_1D_array_precallback_complex_to_complex<float, cl_float,
                                                  fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       large_1D_array_precallback_complex_to_complex) {
  try {
    large_1D_array_precallback_complex_to_complex<double, cl_double,
                                                  fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    astoundingly_large_1D_precallback_complex_to_complex<float, cl_float,
                                                         fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       DISABLED_astoundingly_large_1D_precallback_complex_to_complex) {
  try {
    astoundingly_large_1D_precallback_complex_to_complex<double, cl_double,
                                                         fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       small_1D_non_unit_stride_hermitian_to_real) {
  try {
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    single_point_1D_forward_precallback_complex_to_complex<float, cl_float,
                                                           fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_1D_forward_precallback_complex_to_complex) {
  try {
    single_point_1D_forward_precallback_complex_to_complex<double, cl_double,
                                                           fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    single_point_1D_backward_precallback_complex_to_complex<float, cl_float,
                                                            fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_1D_backward_precallback_complex_to_complex) {
  try {
    single_point_1D_backward_precallback_complex_to_complex<double, cl_double,
                                                            fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    small_2D_non_unit_stride_precallback_complex_to_complex<float, cl_float,
                                                            fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       small_2D_non_unit_stride_precallback_complex_to_complex) {
  try {
    small_2D_non_unit_stride_precallback_complex_to_complex<double, cl_double,
                                                            fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    rectangular_2D_array_precallback_complex_to_complex<float, cl_float,
                                                        fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       rectangular_2D_array_precallback_complex_to_complex) {
  try {
    rectangular_2D_array_precallback_complex_to_complex<double, cl_double,
                                                        fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    large_2D_array_forward_precallback_complex_to_complex<float, cl_float,
                                                          fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       large_2D_array_forward_precallback_complex_to_complex) {
  try {
    large_2D_array_forward_precallback_complex_to_complex<double, cl_double,
                                                          fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    large_2D_array_backward_precallback_complex_to_complex<float, cl_float,
                                                           fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       large_2D_array_backward_precallback_complex_to_complex) {
  try {
    large_2D_array_backward_precallback_complex_to_complex<double, cl_double,
                                                           fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       single_point_2D_forward_precallback_complex_to_complex) {
  try {
    single_point_2D_forward_precallback_complex_to_complex<float, cl_float,
                                                           fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_2D_forward_precallback_complex_to_complex) {
  try {
    single_point_2D_forward_precallback_complex_to_complex<double, cl_double,
                                                           fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    single_point_2D_backward_precallback_complex_to_complex<float, cl_float,
                                                            fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_2D_backward_precallback_complex_to_complex) {
  try {
    single_point_2D_backward_precallback_complex_to_complex<double, cl_double,
                                                            fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    single_point_3D_forward_precallback_complex_to_complex<float, cl_float,
                                                           fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_3D_forward_precallback_complex_to_complex) {
  try {
    single_point_3D_forward_precallback_complex_to_complex<double, cl_double,
                                                           fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    single_point_3D_backward_precallback_complex_to_complex<float, cl_float,
                                                            fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       single_point_3D_backward_precallback_complex_to_complex) {
  try {
    single_point_3D_backward_precallback_complex_to_complex<double, cl_double,
                                                            fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       small_3D_non_unit_stride_precallback_complex_to_complex) {
  try {
    small_3D_non_unit_stride_precallback_complex_to_complex<float, cl_float,
                                                            fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       small_3D_non_unit_stride_precallback_complex_to_complex) {
  try {
    small_3D_non_unit_stride_precallback_complex_to_complex<double, cl_double,
                                                            fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       small_3D_non_unit_stride_and_distance_precallback_complex_to_complex) {
  try {
    small_3D_non_unit_stride_and_distance_precallback_complex_to_complex<
        float, cl_float, fftwf_complex>();
  } catch (const std::exception &err) {
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    normal_1D_round_trip_precallback_complex_to_complex<float, cl_float,
                                                        fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_1D_round_trip_precallback_complex_to_complex) {
  try {
    normal_1D_round_trip_precallback_complex_to_complex<double, cl_double,
                                                        fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       normal_2D_round_trip_precallback_complex_to_complex) {
  try {
    normal_2D_round_trip_precallback_complex_to_complex<float, cl_float,
                                                        fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_2D_round_trip_precallback_complex_to_complex) {
  try {
    normal_2D_round_trip_precallback_complex_to_complex<double, cl_double,
                                                        fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    small_3D_round_trip_precallback_complex_to_complex<float, cl_float,
                                                       fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       small_3D_round_trip_precallback_complex_to_complex) {
  try {
    small_3D_round_trip_precallback_complex_to_complex<double, cl_double,
                                                       fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
void normal_1D_round_trip_precallback_real_to_complex() {
  ...
  data_pattern pattern = impulse;
  precallback_real_to_complex_round_trip<T, cl_T, fftw_T>(pattern, lengths,
                                                          batch);
}

TEST_F(accuracy_test_pow5_precallback_single,
       normal_1D_round_trip_precallback_real_to_complex) {
  try {
    normal_1D_round_trip_precallback_real_to_complex<float, cl_float,
                                                     fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_1D_round_trip_precallback_real_to_complex) {
  try {
    normal_1D_round_trip_precallback_real_to_complex<double, cl_double,
                                                     fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    large_1D_round_trip_precallback_real_to_complex<float, cl_float,
                                                    fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       large_1D_round_trip_precallback_real_to_complex) {
  try {
    large_1D_round_trip_precallback_real_to_complex<double, cl_double,
                                                    fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
       normal_2D_round_trip_precallback_real_to_complex) {
  try {
    normal_2D_round_trip_precallback_real_to_complex<float, cl_float,
                                                     fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       normal_2D_round_trip_precallback_real_to_complex) {
  try {
    normal_2D_round_trip_precallback_real_to_complex<double, cl_double,
                                                     fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_single,
  ...
  try {
    small_3D_round_trip_precallback_real_to_complex<float, cl_float,
                                                    fftwf_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
...
TEST_F(accuracy_test_pow5_precallback_double,
       small_3D_round_trip_precallback_real_to_complex) {
  try {
    small_3D_round_trip_precallback_real_to_complex<double, cl_double,
                                                    fftw_complex>();
  } catch (const std::exception &err) {
    handle_exception(err);
  }
