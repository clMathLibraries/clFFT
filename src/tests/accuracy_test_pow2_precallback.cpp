...
TEST_F(accuracy_test_pow2_precallback_single,
...
TEST_F(accuracy_test_pow2_precallback_double,
       normal_1D_forward_in_place_complex_planar_to_complex_planar) {
  try {
    normal_1D_forward_in_place_complex_planar_to_complex_planar<
...
TEST_F(accuracy_test_pow2_precallback_single,
       large_1D_1048576_forward_in_place_complex_planar_to_complex_planar) {
  try {
    large_1D_1048576_forward_in_place_complex_planar_to_complex_planar<
        float, cl_float, fftwf_complex>();
  } catch (const std::exception &err) {
...
TEST_F(
    accuracy_test_pow2_precallback_single,
    large_1D_1048576_forward_in_place_complex_interleaved_to_complex_interleaved) {
  try {
    large_1D_1048576_forward_in_place_complex_interleaved_to_complex_interleaved<
        float, cl_float, fftwf_complex>();
  } catch (const std::exception &err) {
...
TEST_F(accuracy_test_pow2_precallback_single,
       large_1D_array_complex_to_complex) {
  try {
...
TEST_F(accuracy_test_pow2_precallback_single,
       single_point_1D_backward_complex_to_complex) {
  try {
...
TEST_F(accuracy_test_pow2_precallback_single,
       rectangular_2D_array_complex_to_complex) {
  try {
...
TEST_F(accuracy_test_pow2_precallback_single,
       testcase1_2D_round_trip_complex_to_complex) {
  try {
...
TEST_F(accuracy_test_pow2_precallback_single,
       large_1D_round_trip_real_to_complex) {
  try {
