...
#define PRE_MULVAL                                                             \
  float2 mulval_pre(__global void *in, uint offset,                            \
...
#define PRE_MULVAL_DP                                                          \
  double2 mulval_pre(__global void *in, uint offset,                           \
                     __global void *userdata)\n {                              \
...
#define PRE_MULVAL_PLANAR                                                      \
  float2 mulval_pre(__global void *inRe, __global void *inIm, uint offset,     \
                    __global void *userdata)\n {                               \
    \n float scalar = *((__global float *)userdata + offset);                  \
    \n float2 ret;                                                             \
...
#define PRE_MULVAL_PLANAR_DP                                                   \
  double2 mulval_pre(__global void *inRe, __global void *inIm, uint offset,    \
                     __global void *userdata)\n {                              \
    \n double scalar = *((__global double *)userdata + offset);                \
    \n double2 ret;                                                            \
...
#define PRE_MULVAL_REAL                                                        \
  float mulval_pre(__global void *in, uint offset,                             \
                   __global void *userdata)\n {                                \
    \n float scalar = *((__global float *)userdata + offset);                  \
...
#define PRE_MULVAL_REAL_DP                                                     \
  double mulval_pre(__global void *in, uint offset,                            \
                    __global void *userdata)\n {                               \
    \n double scalar = *((__global double *)userdata + offset);                \
...
#define POST_MULVAL                                                            \
  void mulval_post(__global void *output, uint outoffset,                      \
...
#define POST_MULVAL_DP                                                         \
  void mulval_post(__global void *output, uint outoffset,                      \
                   __global void *userdata, double2 fftoutput)\n {             \
...
#define POST_MULVAL_PLANAR                                                     \
  void mulval_post(__global void *outputRe, __global void *outputIm,           \
                   size_t outoffset, __global void *userdata,                  \
                   float fftoutputRe, float fftoutputIm)\n {                   \
    \n float scalar = *((__global float *)userdata + outoffset);               \
...
#define POST_MULVAL_PLANAR_DP                                                  \
  void mulval_post(__global void *outputRe, __global void *outputIm,           \
                   size_t outoffset, __global void *userdata,                  \
                   double fftoutputRe, double fftoutputIm)\n {                 \
    \n double scalar = *((__global double *)userdata + outoffset);             \
...
#define POST_MULVAL_REAL                                                       \
  void mulval_post(__global void *output, uint outoffset,                      \
                   __global void *userdata, float fftoutput)\n {               \
    \n float scalar = *((__global float *)userdata + outoffset);               \
...
#define POST_MULVAL_REAL_DP                                                    \
  void mulval_post(__global void *output, uint outoffset,                      \
                   __global void *userdata, double fftoutput)\n {              \
    \n double scalar = *((__global double *)userdata + outoffset);             \
...
// inputs to the tests; these should be removed once the size restriction on
// transfrom lengths (SP 2^24 and DP 2^22) is removed; the dlarge* constants can
// then be removed
