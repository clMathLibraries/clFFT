...
TEST_F(accuracy_test_pow3_precallback_single,
...
TEST_F(accuracy_test_pow3_precallback_double,
       normal_1D_forward_in_place_complex_planar_to_complex_planar) {
  try {
    normal_1D_forward_in_place_complex_planar_to_complex_planar<
...
// 14348907 = 2187 * 2187 * 3 backward and forward, planar and interleaved,
