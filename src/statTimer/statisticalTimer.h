...
//	Definition of a functor object that is passed by reference into the
//Print statement 	of the timing class. 	Functor object to help with accumulating
//values in vectors
...
protected:
  ...
  //	friend std::ostream& operator<<( std::ostream& os, const baseStatTimer&
  //s );
