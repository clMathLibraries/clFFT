...
class CpuStatTimer : public baseStatTimer {
  ...
  //by dividing by the 	clock frequency
  bool normalize;
...
public:
  ...
  size_t getUniqueID(const std::string &label, cl_uint groupID) override;
  ...
  std::vector<size_t> pruneOutliers(size_t id, cl_double multiple) override;
};
