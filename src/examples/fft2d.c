...
int main(void) {
  ...
  printf("\nPerforming fft on an two dimensional array of size N0 x N1 : %lu x "
         "%lu\n",
  ...
  err = clEnqueueWriteBuffer(queue, bufX, CL_TRUE, 0, buffer_size, X, 0, NULL,
                             NULL);
  ...
  err = clEnqueueReadBuffer(queue, bufX, CL_TRUE, 0, buffer_size, X, 0, NULL,
                            NULL);
